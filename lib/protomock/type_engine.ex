...
# to ProtoMock.TypeEngine, and select functionality from Hammox.Cache and Hammox.Utils
# has been inlined into this module.
defmodule ProtoMock.TypeEngine do
  @moduledoc false
  ...
  defp resolve_remote_type(remote_type) do
    case cache_get(remote_type) do
      nil ->
        case do_resolve_remote_type(remote_type) do
          {:ok, _} = ok ->
            cache_put(remote_type, ok)
            ok
